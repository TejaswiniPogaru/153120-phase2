...
public class WalletTest {
	...
	public void initData() {
		...
		cust1 = new Customer("Sangamesh", "9876543210", new Wallet(new BigDecimal(9000)));
		cust2 = new Customer("Eshwar", "9741258963", new Wallet(new BigDecimal(6000)));
		cust3 = new Customer("Siva", "9701638333", new Wallet(new BigDecimal(7000)));
	...
	public void testCreateAccount1() {
		...
		cust = service.createAccount("Sangamesh", "9876543210", new BigDecimal(7000));
	...
	public void testFundTransfer2() {
		cust1 = service.fundTransfer("9876543210", "9741258963", new BigDecimal(2000));
	...
	public void testDeposit2() {
		cust1 = service.depositAmount("9876543210", new BigDecimal(2000));
		BigDecimal actual = cust1.getWallet().getBalance();
		BigDecimal expected = new BigDecimal(8000);
		//assertEquals(expected, actual);
	}
	...
	public void testWithdraw2() {
		cust1 = service.withdrawAmount("9876543210", new BigDecimal(2000));
		BigDecimal actual = cust1.getWallet().getBalance();
